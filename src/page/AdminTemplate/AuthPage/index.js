  ...
  return (
    ...
    <div className="modal-dialog">
      <div className="modal-content" style={{backgroundColor: '#0c1a2a'}}>
       ...
       <div className="modal-header">
          <h4 className="modal-title" style={{color: '#F9C227'}}>ĐĂNG NHẬP ADMIN</h4>
          <NavLink to="/">
    ...
    <div className="d-flex">
        ...
        <div className="modal-footer">
              <button type="button" id="clickButtonLG" className="btn btn-default" data-dismiss="modal" style={{color: '#fdb813', backgroundColor: '#0c1a2a', borderColor: '#fdb813'}}>EXIT</button>
        </div>  
        </NavLink>
      </div>
    </div>
